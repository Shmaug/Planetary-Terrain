...
{
    class RidgedMultiFractalSpectralGenerator2 : ISpectralGenerator
    {
        ...
        public double AccumulateNoise(Vector3d sampleLocation, int numberOfOctaves, double lacunarity, double gain, double offset)
        {
